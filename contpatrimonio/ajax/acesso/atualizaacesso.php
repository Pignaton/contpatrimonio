...
$ativo = $_POST['txtativo'];
	...
	try {
		...
		$libera_acesso = "UPDATE pagina_acesso SET dashboard = $dashboard, cadastro_ativo = $cadastro, tabela_manutencao = $tabela_manutencao, tabela_baixa = $tabela_baixa, acesso = $acesso, backup = $backup WHERE id_pagina = $id_pagina";
