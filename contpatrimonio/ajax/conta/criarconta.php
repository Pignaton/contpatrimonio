...
try{
	...
	$query_pagina = $patrimonio->prepare("INSERT INTO pagina_acesso (funcionario, dashboard, cadastro_ativo, tabela_manutencao, tabela_baixa, acesso, registra_manutencao, backup, conta, documentacao) VALUES ( :funcionario, :dashboard, :cadastro_ativo, :tabela_manutencao, :tabela_baixa, :acesso, :registra_manutencao, :backup, :conta, :documentacao)");
	$query_pagina->execute(array(
		':funcionario' => $id,
		':dashboard' => $dashboard,
