					...
					<div class="row">
						...
						<div class="col-sm-3">
							<div class="form-group">
								...
								<input type="text" class="form-control" onkeypress="return letras();" name="txtcodigo" id="txtcodigo" required>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">
								...
								<textarea class="form-control" name="txtdescricao" id="txtdescricao" rows="3" style="resize:none;" required></textarea>
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-sm-3">
							<div class="form-group">
								...
								<select class="form-control" name="txtstatus" id="txtstatus" required>
									<option value="1" selected="">Em uso</option>
								<select>
							</div>
						</div>
						<div class="col-sm-9">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="txtnotafiscal" id="txtnotafiscal" value="" required> &nbsp;
