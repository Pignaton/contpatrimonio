		...
		<div class="col-sm">
                  <div class="table-wrapper">
                        ...
                        <div>
                              ...
                              <p>Para visualizar ou acompanhar os ativos em manutenção, no menu procure por <label>manutenção</label> e clique em <label>Registrar manutenção</label></p>
                        </div>
                        <br>
                        <div>
                              <div class="titulo-documentacao">
                                    <h4 class="text-center">Página de Registro de Manutenção</h4>
                              </div>
                              <br>
                              <p>No menu <i class="fas fa-bars"></i> acesse a aba <strong>"manutenção"</strong> e clique em <strong>Registrar manutenção</strong></p>
                              <p>Essa tabela exibirá todas os ativos que estão em manutenção ou já passaram por manutenção</p>
                              <p>E clicando em <button class="btn btn-sm btn-primary">Abrir</button> será exibido todas a manutenção que aquele ativo já passou e se tive ainda em manutenção será exbido <strong class="text-danger">Em manutenção</strong> na coluna <strong>Data Devolução</strong></p>
                        </div>
			</div>
		</div>
	</div>
